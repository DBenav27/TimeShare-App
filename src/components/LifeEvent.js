          ...
          <div className="row">
            <div className="lifeEvent card pull-center">
              ...
              <div className="card-block">
                ...
                <h5 className="event-date" >{ this.props.data.eventDate }</h5>

                <span className="pull-center">rating: { this.props.data.userRating }</span><br/>
            ...
            <div className="col-sm-2 pull-left theline">
              <img className="img-dash" src="images/dashline.png" alt="line"></img>
            </div>
          </div> :
        <div></div>
      }
